...
<script type="text/javascript">
	...
	$(function(){
		$("#gender option[value=${condition.student.sgender }]").prop("selected", true);
		$("#banji_id option[value=${condition.student.sbanji_id }]").prop("selected", true);
	});
			...
			<div class="col-md-10">
				...
				<form id="searchForm" action="${pageContext.request.contextPath}/student/seacherByCondition.action" method="post" class="form-inline" style="float: left; margin-top: 10px;margin-bottom: 10px;" >
					...
					<div class="form-group"  >
					    ...
					    <input type="text" name="student.sname" value="${condition.student.sname }" class="form-control" id="exampleInputName2" placeholder="姓名">
				 	</div>
					<div class="form-group">
					<label for="exampleInputName2">年龄：</label>
					    <input type="text" name="student.sage" value="${condition.student.sage }" class="form-control" id="exampleInputName2" placeholder="年龄">
				 	</div>
					<div class="form-group">
						<label for="exampleInputName2">性别：</label>
						<select id="gender" name="student.sgender" class="form-control" >
					...
					<div class="form-group">
					    ...
					    <input type="text" name="student.saddress" value="${condition.student.saddress }" class="form-control" id="exampleInputName2" placeholder="地址">
				 	</div>
					<div class="form-group" style="width: 180px;">
						<label for="exampleInputName2">出生日期：</label>
					    <input type="text" name="student.sbirthday" value="${condition.student.sbirthday }" style="width: 100px" class="form-control" id="exampleInputName2" placeholder="出生日期">
				 	</div>
				 	<div class="form-group">
						<label for="exampleInputName2">班级：</label>
						<select class="form-control" id="banji_id" name="student.sbanji_id" >
							<option value="" >请选择</option>
